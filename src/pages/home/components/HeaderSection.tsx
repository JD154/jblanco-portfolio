...
export const HeaderSection = () => {
  return (
    <section
      id="header-section"
      className="max-w-2xl lg:max-w-4xl mx-auto absolute top-1/2 left-1/2  z-10 -translate-y-1/2 -translate-x-1/2 flex items-center flex-col justify-center text-center"
    >
